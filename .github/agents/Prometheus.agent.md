...
tools: ['edit', 'search', 'usages', 'problems', 'changes', 'testFailure', 'runSubagent']
...
1. **Understand the Request:**
   ...
   - Classify request type: new feature vs bugfix/chore/refactor/docs
   - Include branch strategy guidance for Atlas based on that classification
...
**Branch Strategy:** {If new feature on master: create `feat/<task-slug>`; otherwise continue current branch}
...
- **Request Type:** {Feature | Bugfix | Chore | Refactor | Docs}
- **Recommended Working Branch:** {`feat/<task-slug>` | current branch}
...
- **Branch-aware:** Explicitly state whether Atlas should create a feature branch from `master`
