...
1. **Kontobundet byte av HA-anslutning:** den befintliga WebSocket-managern jämför aktiverade konto-ID:n men inte anslutningens revision. Inställningsbyte garanterar därför ännu inte omedelbar återanslutning med ny REST-startbild. Den nya katalogen underkänner den gamla bilden tills en ny finns; GET-knappen startar inte om socketen. Nästa implementation behöver säker revisionsstyrd omladdning, avbrotts-/race-tester och tydlig UI-återkoppling, utan styrkommandon eller verkliga credentialändringar.
