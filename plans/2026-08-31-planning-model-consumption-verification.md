...
1. Slutlig plan-/solverresultatvalidering och aktiv LWT-konsumtion är genomförd i [uppföljningen 2026-09-01](2026-09-01-solver-plan-control-verification.md). Full horisont/tidsaxel, komfort, effekt/kostnad, Shadow-spärr, modell-/konfigurationsåterkallelse, aktuellt plansteg och aktiv telemetrikvalitet avvisas fail-closed. Kontrollen före HA-anropet är fortfarande **inte en atomisk PostgreSQL- eller fysisk skrivbarriär**, och planens 0,85-konfidens är fortsatt en heuristik.
