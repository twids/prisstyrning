...
- Nästa avgränsade UX-uppföljning: rumsvyn visar även informationshändelser om återhämtade givare som varningar. Bevara händelsens verkliga allvarlighetsgrad och skilj historik från aktiva larm; felet syntes i testbilderna och är ännu inte rättat.
